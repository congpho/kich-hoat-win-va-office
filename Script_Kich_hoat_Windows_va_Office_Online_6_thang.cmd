...
title Script Kich hoat Windows va Office Online 6 thang
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [3] _Thong tin ve Script Kich hoat_                   ^|
Echo.                    ^|                   _______________                       ^|  
echo.                    ^|                                                         ^|
echo.                    ^|   [4] Tao tac vu Gia han Kich hoat.                     ^| 
echo.                    ^|                                                         ^| 
echo.                    ^|   [5] Xoa cac tep da tao khi Kich hoat.                 ^| 
echo.                    ^|                                                         ^|
echo.                    ^|   [6] Trich xuat Thu muc $OEM$ ra Desktop.              ^|  
Echo.                    ^|                   _______________                       ^|  
echo.                    ^|                                                         ^|       
Echo.                    ^|   [7] Kiem tra Cap nhat Script.                         ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [8] Thoat.                                            ^|
Echo.                    ^|_________________________________________________________^|
ECHO.            
choice /C:12345678 /N /M ".                       Nhap lua chon cua ban [1,2,3,4,5,6,7,8] : "
...
if errorlevel 2 goto:CheckActivation
...
REM ReadMe Start
 ...
 - Script CMD Kich hoat Windows va Office Online 6 thang
 ...
 - Neu ban chi muon kich hoat trong 6 thang va khong muon bat ky phan con lai nao cua qua trinh
 ...
 - Neu ban muon kich hoat VINH VIEN, thi ban nen chon tuy chon [1] Kich hoat Windows va Office.
   ...
   internet mot lan trong khoang thoi gian 6 thang, de kich hoat VINH VIEN.

 - Sau khi chon [1] Kich hoat hoac [4] Gia han Kich hoat, neu ban khong [5] Xoa cac tep da tao
   khi Kich hoat. Ma cai luon Office 2013 hay 2016 (Volume) thi Office cua ban se tu dong duoc 
 ...
 - Doi voi hau het Windows va Office thoi gian Kich hoat se la 6 thang/lan. Nhung doi voi mot
   so san pham thoi gian co the se ngan hon la 30 ngay/lan hoac 45 ngay/lan ...
                                                                                               
 - Scipt se Kich hoat cac ban Office VL (Volume), khong ho tro Kich hoat Office Retail (C2R).  
   Vi vay hoac ban convert Office Retail sang VL, hoac tai xuong Office VL tu lien ket nay: 
 ...
 - De tao file iso kich hoat tu dong khi cai Win hay thuc hien thao tac sau:
   ...
   Tiep theo sao chep thu muc $OEM$ nay vao thu muc "sources" trong file iso goc.              
 ...
 * Neu trong qua trinh kich hoat gap loi, Hay thu reset lai file Tokens.dat bang cach sau     
   Chay CMD (command prompt) voi Quyen quan tri (run as admin...). Copy-paste lenh duoi vao:
 ...
 - Voi Windows 7, Server 2008 R2:
   ...
   Doi qua trinh tren hoan tat, Reset may lai 2 lan.
 ...
 # Cac Phien ban duoc Ho tro: 
   ...
   Windows 7 Volume (Vi du: Pro, Enterprise)/8/8.1/10 
 ...
 # Tac gia: 
   ...
   Abbodi1406     - Tao tep SppExtComObjPatcher-kms\2-Activate-Local.cmd duoc su dung lsm co so
                    trong 'Script Kich hoat Windows va Office Online 6 thang' nay.
 ...
 - Script Kich hoat Win va Office Online 6 thang: http://bit.ly/KichHoatWindowsVaOfficeOnline
 - Scrip kich hoat Windows 10 ban quyen Vinh Vien: http://bit.ly/KichHoatBanQuyenVinhVien
 ...
 - Key Windows 10 - Windows Server Mac Dinh cua Microsoft: http://bit.ly/KeyGeneric
 - Link tai Win10 Enterprise LTSB 2016 x64 nguyen goc: http://bit.ly/enterpriseLTSB2016x64
 - Link tai Win10 Enterprise LTSB 2016 x32 nguyen goc: http://bit.ly/enterpriseLTSB2016x32
 - Link tai Win10 Enterprise LTSB 2015 x64 nguyen goc: http://bit.ly/LTSB2015x64
 - Link tai Win10 Enterprise LTSB 2015 x32 nguyen goc: http://bit.ly/LTSB2015x32
 ...
 - Phan mem ho tro duyet tab trong Office nhu tren trinh duyet Web: http://bit.ly/OfficeTabver12
...
echo       ============================================================================
echo          Luu y: De Kich hoat thanh cong hay dam bao ban da ket noi voi Internet.
echo       ============================================================================
echo.
choice /C:QT /N /M "[T] Tiep tuc Kich hoat [Q] Quay lai : "
...
echo      ============================================================================
echo       Luu y: Tuy chon nay se tao Tac vu Gia han Kich hoat tu dong Hang tuan. 
echo              He thong cua ban phai ket noi Internet 1 lan trong khoang thoi gian
echo              6 thang, de Kich hoat Vinh Vien.
echo              Tep tac vu se duoc tao trong C:\Windows\Online_KMS_Activation_Script
echo              Va ban co the xem tac vu theo lich cua no trong Task Schedular.
echo      ============================================================================
echo.
choice /C:QT /N /M "[T] Tao tac vu Gia han [Q] Quay lai : "
        if %errorlevel%==1 Goto:MainMenu
		cls
...
echo.
echo =========================================
echo     Da tao Tac vu Gia han Hang tuan.
echo =========================================
echo.
echo Nhan phim bat ky de tiep tuc...
pause >nul
...
mode con cols=98 lines=30
echo       ================================================================================
echo        Luu y: Tuy chon nay se xoa Tac vu Gia han tu dong, tep tac vu, xoa bo nho cache
echo               va ten May chu KMS tren He thong.
echo       ================================================================================
echo.
choice /C:QT /N /M "[T] Tiep tuc Xoa cac tep da tao [Q] Quay lai : "
        if %errorlevel%==1 Goto:MainMenu
		cls
		
echo Dang Xoa Tac vu Gia han Tu dong...
schtasks /delete /tn Online_KMS_Activation_Script-Renewal /f 1>nul 2>nul
schtasks /delete /tn Online_KMS_Activation_Script-Run_Once /f 1>nul 2>nul
echo Dang Xoa Tep Tac vu...
@RD /s /q "%windir%\Online_KMS_Activation_Script" >nul 2>&1
...
echo.
echo ==============================
echo  Hoan tat Xoa cac tep da tao.
echo ==============================
echo.
echo Nhan phim bat ky de tiep tuc...
pause >nul
...
mode con cols=98 lines=30
echo     ==================================================================================
echo       Luu y: Tuy chon nay se tao thu muc $OEM$ cua Script Kich hoat tren Desktop,   
echo              Ban co the su dung no de tao file iso tu kich hoat khi cai dat Win. 
echo              De biet them thong tin, hay su dung lua chon [3].
echo     ==================================================================================
echo.
choice /C:QT /N /M "[T] Tao thu muc $OEM$ [Q] Quay lai : "
        if %errorlevel%==1 Goto:MainMenu
		cls
...
echo.
echo               ================================================
echo                 Loi - Thu muc $OEM$ khong duoc tao vi co mot
...
if %server_num% gtr !max_servers! (
	if defined Renewal_Task (echo Khong co May chu KMS. Dang thoat...&exit 1651565635 rem Dummy Numbers To Show Error In Task)
	if defined Run_Once (echo Khong co May chu KMS. Dang thoat...&exit 1651565635 rem Dummy Numbers To Show Error In Task)
	echo Khong co May chu KMS, Nhan phim bat ky de tiep tuc & pause>nul & goto:EOF)
	
set KMS_IP=!server[%server_num%]!
echo. &echo Dang thu voi May chu KMS %KMS_IP% &echo.
...
echo.
if %activation_ok%==0 (
echo Kich hoat khong thanh cong. Dang thu mot may chu khac.
set /a server_num+=1
goto :server
)
if defined Renewal_Task (echo Dang thoat...&exit)
if defined Run_Once (schtasks /delete /tn Online_KMS_Activation_Script-Run_Once /f 1>nul 2>nul &del /f /q %windir%\Online_KMS_Activation_Script\Online_KMS_Activation_Script-Run_Once.cmd >nul 2>&1 &echo Dang thoat...&exit)
Echo.
echo Nhan phim bat ky de tiep tuc.
pause>nul
Goto:EOF
...
for /f "tokens=2 delims==" %%x in ('"wmic path %spp% where ID='%app%' get Name /VALUE"') do echo Kiem tra: %%x
echo San pham duoc Kich hoat Vinh Vien.
exit /b
)
call :insKey %app%
exit /b
...
echo.
set "key="
for /f "tokens=2 delims==" %%A in ('"wmic path %spp% where ID='%1' get Name /VALUE"') do echo Dang cai dat Key cho: %%A
for /f %%A in ('cscript //Nologo "%temp%\key.vbs"') do set "key=%%A"
del /f /q "%temp%\key.vbs" >nul 2>&1
if "%key%" EQU "" (echo Khong the tim thay Key KMS Client phu hop &exit /b)
...
for /f "tokens=2 delims==" %%x in ('"wmic path %spp% where ID='%1' get Name /VALUE"') do echo Dang Kich hoat: %%x
...
if %gpr% equ 43200 if %office% equ 0 if not defined win7 (echo Kich hoat Windows Core/ProfessionalWMC Thanh cong&echo Thoi gian con lai: 30 ngay ^(%gpr% minutes^)&exit /b)
if %gpr% equ 64800 (echo Kich hoat Windows Core/ProfessionalWMC Thanh cong&echo Thoi gian con lai: 45 ngay ^(%gpr% minutes^)&exit /b)
if %gpr% gtr 259200 (echo Kich hoat Windows EnterpriseG/EnterpriseGN Thanh cong&echo Thoi gian con lai: %gpr2% ngay ^(%gpr% minutes^)&exit /b)
if %gpr% equ 259200 (
echo Kich hoat San pham Thanh cong
) else (
call cmd /c exit /b %ERRORCODE%
echo Kich hoat San pham That bai: 0x%=ExitCode%
set activation_ok=0
)
echo Thoi gian con lai: %gpr2% ngay ^(%gpr% minutes^)
exit /b

:UnsupportedVersion
echo ==== LOI ====
echo Phien ban He Dieu Hanh khong duoc Ho tro.
echo Script chi ho tro cho Windows 7/8/8.1/10 va Phien ban Windows Server tuong ung.
echo.
echo Nhan phim bat ky de thoat...
pause >nul
goto :eof
...
::
REM Info Start
Viec su dung Script nay la de tu dong Gia han Kich hoat Windows va Office cua ban.
Ban co the xem tac vu duoc len lich cua no trong "Task Scheduler"

Day la file Kich hoat Windows va Office nhe nhat cung nhu Hoan toan Sach 100%.

De biet them thong tin Cap nhat ve Script vui long lien he: https://www.facebook.com/Saviopqt
REM Info End
::
:SetupCompleteFinal
schtasks /create /tn "Online_KMS_Activation_Script-Renewal" /ru "SYSTEM" /xml "%TEMP%\Online_KMS_Activation_Script-Renewal.xml" >nul 2>&1
...
echo.
echo ======================================================
echo   Thu muc $OEM$ da duoc tao thanh cong tren Desktop.
echo ======================================================
echo Nhan phim bat ky de tiep tuc...
pause >nul
goto:MAINMENU
...
:======================================================================================================================================================
:ScriptUpdates
start https://docs.google.com/document/d/1A9fR40axwkdNfZX1F15oZWgYv_XqnwnNl8Y-tIE7Qo4/
goto:MAINMENU
...
echo.                ============================================================
echo.                                                                   
echo.                Thanks to abbodi1406, rpo, AR_Alex, Savio and WindowsAddict.
echo.                                                                    
echo.                ============================================================
echo.
echo.
